...
# -DI2C_DEBUG -DMPU9150_DEBUG  -DKALMAN_DEBUG  -DAHRS_DEBUG  -DMEMWATCH -DMEMWATCH_STDIO -DULTRA_DEBUG for debugging
DEFS = -DEMPL_TARGET_LINUX -DMPU9150 -DAK8975_SECONDARY -DULTRA_DEBUG
...
LIBS = -pthread  -lm  -lrt -L $(FENCEDIR)/lib -lortp
...
INCS = -I $(MAVLINKDIR) -I $(MAVLINKDIR2) -I $(SRCDIR)  -I $(HALDIR) \
		...
		-I $(CAMDIR)  -I $(ULRDIR) \
		-I $(ORTPDIR)/include -L $(ORTPDIR)/lib \
		-I $(MEMDIR)
